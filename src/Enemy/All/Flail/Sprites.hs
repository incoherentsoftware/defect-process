module Enemy.All.Flail.Sprites
    ( EnemySprites(..)
    , mkEnemySprites
    ) where
...
mkEnemySprites =
    ...
    loadPackSpr "idle-to-walk.spr" <*>
    loadPackSpr "walk-to-idle.spr" <*>
    ...
    where loadPackSpr = \f -> loadPackSprite $ PackResourceFilePath "data/enemies/flail-enemy.pack" f
